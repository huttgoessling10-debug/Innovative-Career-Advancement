        ...
        <Reveal delay={0.3}>
          <div className="mt-12 flex flex-col items-start gap-8 sm:flex-row sm:items-center sm:gap-10">
            <MagneticButton
              ...
              className="inline-flex items-center justify-center bg-red px-9 py-5 text-sm font-bold uppercase tracking-wide text-ink transition-all duration-300 hover:shadow-[0_0_40px_rgba(255,30,60,0.55)]"
            >
              {contact.ctaLabel}
            </MagneticButton>
            ...
            <a
              ...
              data-cursor-hover
              className="text-lg font-bold text-red underline decoration-2 underline-offset-8 transition-colors hover:text-paper sm:text-xl"
            >
              {business.email}
            </a>
          </div>
