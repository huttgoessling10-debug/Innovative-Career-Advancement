...
export default async function CheckoutErrorPage({
  ...
  return (
    <main className="flex min-h-[100svh] flex-col items-center justify-center px-6 py-28 text-center sm:px-10">
      <p className="text-xs font-bold uppercase tracking-[0.25em] text-yellow">Checkout unavailable</p>
      ...
      <a
        ...
        data-cursor-hover
        className="mt-10 inline-flex items-center justify-center bg-yellow px-8 py-4 text-sm font-bold uppercase tracking-wide text-ink transition-all duration-300 hover:shadow-[0_0_40px_rgba(255,212,0,0.55)]"
      >
        Email {business.shortName}
      </a>
      <Link href="/#pricing" data-cursor-hover className="mt-6 text-sm font-bold uppercase tracking-wide text-yellow underline decoration-2 underline-offset-8 hover:text-paper">
        Back to Pricing
      </Link>
    </main>
  );
