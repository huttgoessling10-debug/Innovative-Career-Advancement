  ...
  return (
    <section className="relative flex min-h-[100svh] flex-col justify-between overflow-hidden pt-32 sm:pt-36">
      ...
      <div className="pointer-events-none absolute inset-0 -z-10">
        ...
        />
        <motion.div
          className="absolute -right-32 top-1/3 h-[480px] w-[480px] rounded-full bg-blue/30 blur-[130px]"
          animate={
            reduceMotion
              ? {}
            ...
            word === "__EMPHASIS__" ? (
              <span key={i} className="inline-block overflow-hidden align-bottom">
                <motion.span
                  ...
                  className="mr-[0.25em] inline-block bg-gradient-to-r from-red to-blue bg-clip-text text-transparent"
                >
        ...
        <div className="mt-10 flex flex-col items-start gap-8 sm:mt-14 sm:flex-row sm:items-end sm:justify-between">
          ...
          >
            <MagneticButton
              ...
              className="inline-flex items-center justify-center bg-red px-7 py-4 text-sm font-bold uppercase tracking-wide text-paper shadow-[0_0_0_rgba(232,39,42,0)] transition-all duration-300 hover:shadow-[0_0_40px_rgba(30,58,240,0.55)] sm:px-9 sm:py-5"
            >
            ...
            <a
              ...
              data-cursor-hover
              className="text-sm font-bold uppercase tracking-wide text-paper underline decoration-blue decoration-2 underline-offset-8 transition-colors hover:text-blue"
            >
