    ...
    >
      <div className="mx-auto flex max-w-[1600px] items-center justify-between px-6 py-5 sm:px-10">
        ...
        <MagneticButton
          ...
          className="inline-flex items-center border-2 border-red bg-transparent px-5 py-2.5 text-xs font-bold uppercase tracking-wide text-paper transition-colors duration-300 hover:bg-blue hover:border-blue hover:text-paper sm:px-6 sm:py-3 sm:text-sm"
        >
          Contact
        </MagneticButton>
      </div>
